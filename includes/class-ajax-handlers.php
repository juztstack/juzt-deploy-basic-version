...
class JUZT_DEPLOY_BASIC_AJAX_Handlers
{
    ...
    public function __construct()
    {
        ...
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_get_organizations', array($this, 'get_organizations'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_get_repositories', array($this, 'get_repositories'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_get_branches', array($this, 'get_branches'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_detect_repo_type', array($this, 'detect_repo_type'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_clone_repository', array($this, 'clone_repository'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_update_repository', array($this, 'update_repository'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_switch_branch', array($this, 'switch_branch'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_remove_repository', array($this, 'remove_repository'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_disconnect_github', array($this, 'ajax_disconnect_github'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_download_wp_content', array($this, 'download_wp_content'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_serve_zip', array($this, 'serve_zip_file'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_retry_commit', array($this, 'retry_commit'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_delete_commit', array($this, 'delete_commit'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_get_progress', array($this, 'get_progress'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_push_all_changes', array($this, 'push_all_changes'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_get_repositories_by_installation', array($this, 'get_repositories_by_installation'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_search_repositories_by_name', array($this, 'JUZT_DEPLOY_BASIC_search_repositories_by_name'));
        add_action('wp_ajax_JUZT_DEPLOY_BASIC_bulk_delete_commits', array($this, 'bulk_delete_commits'));
    }

    public function JUZT_DEPLOY_BASIC_search_repositories_by_name()
    {
        check_ajax_referer('JUZT_DEPLOY_BASIC_nonce', 'nonce');
    ...
    public function get_organizations()
    {
        ...
        update_option('JUZT_DEPLOY_BASIC_github_user', $user_result['user']['data']);
    ...
    public function ajax_disconnect_github()
    {
        ...
        delete_option('JUZT_DEPLOY_BASIC_oauth_token');
        delete_option('JUZT_DEPLOY_BASIC_refresh_token');
    ...
    public function download_wp_content()
    {
        ...
        if ($result['success']) {
            ...
            wp_send_json_success(array(
                'download_url' => admin_url('admin-ajax.php?action=JUZT_DEPLOY_BASIC_serve_zip&file=' . urlencode(basename($result['filepath'])) . '&nonce=' . wp_create_nonce('JUZT_DEPLOY_BASIC_download')),
    ...
    public function serve_zip_file()
    {
        ...
        if (!wp_verify_nonce($nonce, 'JUZT_DEPLOY_BASIC_download')) {
    ...
    public function get_progress()
    {
        ...
        $progress = JUZT_DEPLOY_BASIC_Progress_Tracker::get_progress($job_id);
