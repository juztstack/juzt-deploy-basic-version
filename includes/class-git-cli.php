...
class JUZT_DEPLOY_BASIC_Git_CLI extends JUZT_DEPLOY_BASIC_Git_Interface
{
  ...
  public function commit_and_push($repo_path, $file_path, $commit_message, $access_token = '')
  {
    ...
    $github_app_id = get_option('JUZT_DEPLOY_BASIC_github_app_id', '1953130');
    $github_app_name = get_option('JUZT_DEPLOY_BASIC_github_app_name', 'wordpress-theme-versions');
